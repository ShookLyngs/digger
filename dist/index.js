(function (global, factory) {
	...
	*/
	 ...
	 * @type {symbol}
	 */
	var EmptyUpdate = Symbol('empty-update'); // checkers
	...
	var isQuoted = function isQuoted(target) {
	...
	var splitFinder = function splitFinder(target) {
	  return target.split(/(?:\]\[|\]\.|\.|\[|\])+?/g);
	};
	/**
	...
	var removeEmptyInArray = function removeEmptyInArray(array) {
	...
	var removeQuotesInString = function removeQuotesInString(string) {
	...
	var digger = function digger(caller, find) {
	  var update = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : EmptyUpdate;

	  var _ref = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},
	      _ref$untie = _ref.untie,
	      untie = _ref$untie === void 0 ? false : _ref$untie,
	      _ref$extend = _ref.extend,
	      extend = _ref$extend === void 0 ? false : _ref$extend;

	  if (isEmpty(caller) || isEmpty(find)) return void 0;
	  var classified = removeEmptyInArray(splitFinder(find));
	  var stand = caller,
	      index = 0;

	  for (index = 0; index < classified.length; index++) {
	    var current = classified[index];
